...
Power to detect an interaction is lefties' LVF Global bias is 14.37ms or lower (1/2 the effect we saw in our pilot righties).
```{r 14.37ms_n103}
...
##TODO: delete all one-off simulations. Just calculate the p-curve with n=824 subjects as the upper limit, and save it.
...
rt_model_sim_2 <- extend(rt_model_sim, along="subject", n=824)
