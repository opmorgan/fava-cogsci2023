...
*Does the critical 3-way interaction (field by level by handedness) differ depending on shape?*
...
Continuous handedness: In progress.
...
emmtest_FL_H_S(use_cached_model = use_cached_models,
               ...
               FLSH$emm,
               data_label = data_label,
               title = "Global bias by field, by shape (RT)")
```
<br>
