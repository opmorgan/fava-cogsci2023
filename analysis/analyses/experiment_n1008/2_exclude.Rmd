...
```
<br>
Participants are excluded if the handedness in their pre-screener mismatched their EHI-measured handedness.
These "Prescreener/EHI mismatch" exclusions are defined as: 
...
We have recruited 336 "Right handed", and 732 "Left handed" or "Ambidextrous" participants, using Prolific's pre-screeners. 
