...
<br>
<br>
 ***Summary.*** For reaction time, we find the critical interaction in the predicted direction (11.67ms, 95%CI [0.65, 22.69], p = .019, one-sided). Accuracy stats are in progress: the interaction effect will be close to zero, opposite the predicted direction (the point estimates are 1.76 for righties, 1.10 for mixedies, and 1.96 for lefties).
<br>
<br>
...
<br>
```{r}
## Test whether interaction slope differs from zer, with emmeans
