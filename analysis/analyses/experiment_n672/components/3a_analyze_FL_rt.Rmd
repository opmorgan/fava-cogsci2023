```{r}
## Setup
aah_correct_sub <- aah_correct |> filter(sample == subgroup | sample2 == subgroup)
aah_sub <- aah |> filter(sample == subgroup | sample2 == subgroup)
aah_for_rt_model_sub <- aah_for_rt_model |> filter(sample == subgroup | sample2 == subgroup)
```
