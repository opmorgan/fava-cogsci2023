...
## Prepare dataset with only correct trials, and reformat field levels for plotting.
...
aah_for_rt_model <- aah_correct |> 
  ## Recode field and level, so that emmeans will show a positive number for LVF global bias.
